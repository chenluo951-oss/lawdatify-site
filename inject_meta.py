...
OG_DESC = {
    ...
    "kb/standards.html": "个人信息保护、数据安全、网络安全、算法与 AI、移动应用合规，以及网络交易、餐饮外卖、仓储冷链、即时配送、计量、消费者权益与绿色包装等领域的国家标准、法律法规与指引指南汇总，标注效力状态与实施日期，并以全部合规义务为主线组织；可按业务话题直接问出该话题的法律依据清单，条款引用可悬停查看条文原文并跳到引用它的监管案例。",
