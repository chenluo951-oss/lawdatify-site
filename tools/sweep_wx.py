...
QUERIES = [
    ...
    # ---- 2026-09-15 扩容（用户要求：覆盖官方协会组织 / 通报渠道 / 学术机构 / 同行专业人士）----
    # 通报渠道：协会的 App 个人信息优化改进清单、信安标委的标准动态
    ("中国网络空间安全协会 个人信息",     "中国网络空间安全协会"),
    ("中国网络空间安全协会 App",         "中国网络空间安全协会"),
    ("网络安全协会 数据安全 通报",        "中国网络空间安全协会"),
    ("信安标委 人工智能 安全",           "全国信息安全标准化技术委员会"),
    ("信安标委 个人信息 标准",           "全国信息安全标准化技术委员会"),
    ("信通院 数据安全 研究",            "中国信息通信研究院"),
    ("中国互联网协会 数据 合规",         "中国互联网协会"),
    # 学术 / 研究号（研究观点档：有专业价值，但不作监管依据）
    ("数据法学 个人信息保护",            "数据法学"),
    ("数据法学 数据合规",               "数据法学"),
    ("数字法治 个人信息",               "数字法治"),
    ("网络法前哨 数据合规",             "网络法前哨"),
    ...
    ("网数与人工智能法律实务 合规",       "网数与人工智能法律实务"),
    ("智能客服 合规 个人信息",           "网数与人工智能法律实务"),
    ("TMT法律论坛 数据合规",            "TMT法律论坛"),
    ("数据合规 律所 解读",              "网络与数据法律实务"),
]
