...
def build_appviol():
    ...
    # ============================================================ 口径声明
    # 2026-09-17：这段从 568px 的「一整屏方法学」改成默认折叠。
    # 口径必须写明，但它是**附录性质**的内容 —— 展开前先给一行最关键的对外引用口径，
    # 需要核对算法的人点开看 8 条。原来它把正文顶到了 1148px 以下。
    note = [
        '<details class="sp-note sp-warn sp-fold"><summary>'
