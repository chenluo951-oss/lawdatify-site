...
.rd-back{display:block;width:100%;box-sizing:border-box;text-align:left;font-size:13px;
  padding:8px 11px;margin:0 0 11px;border-radius:9px;border:1px solid var(--line);
...
.rd-cur{font-size:13.5px;font-weight:700;line-height:1.5;color:var(--ink);margin:0 0 7px;
  display:-webkit-box;-webkit-line-clamp:2;max-height:3em;-webkit-box-orient:vertical;overflow:hidden}
.rd-tochd{font-size:11.5px;color:var(--faint);margin:0 0 9px;padding:0 0 9px;
  border-bottom:1px solid var(--line-2)}
.rd-toclist{overflow:auto;flex:1;margin:0;padding:0;list-style:none}
...
(function(){
  ...
  function splash(){
    ...
    CUR=null; showPane('list'); renderList();
  }
