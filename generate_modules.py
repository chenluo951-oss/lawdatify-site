...
def update_manifest():
    entries = [
        ...
        },
        {
            "title": "合规动态",
            "url": "news/index.html",
            "desc": "合规动态全貌：立法日历（即将生效）、推进中监管行动、最新监管事件与应对建议、全球监管态势，一屏纵览。",
            "cat": "合规动态",
            "tags": ["倒计时", "施行日", "专项行动", "全球", "地图", "应对建议"],
        },
        {
            "title": "立法日历",
        ...
        {
            "title": "应对建议",
            "url": "news/actions.html",
            "desc": "正在推进的专项治理、检查、立法草案与安全调查，并给出按领域落地建议。",
            "cat": "合规动态",
            "tags": ["专项行动", "清朗", "检查", "调查", "立法进程", "应对建议"],
        },
        {
            "title": "全球监管地图",
            "url": "news/map.html",
